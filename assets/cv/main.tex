...
\begin{onecolentry}
    \textbf{Lenguajes:} Java (Intermedio), Python (Intermedio)\\
    \textbf{Backend:} Spring Boot (Intermedio; JPA/Hibernate, Spring Web, Swagger/OpenAPI), Django (Básico)\\
    \textbf{Bases de Datos:} PostgreSQL (Intermedio; modelo relacional, consultas avanzadas, PL/pgSQL), SQLite (Básico)\\
