...
\begin{twocolentry}{
    ...
    - Gestión de proveedores, productos y stock con punto de venta e historial de movimientos, persistencia con JPA/Hibernate sobre PostgreSQL.\\
    - Documentada con Swagger/OpenAPI, contenerizada con Docker y en producción self-hosted en \href{https://stockflow-api.jromerog.dev/swagger-ui/index.html}{stockflow-api.jromerog.dev}.
\end{twocolentry}
...
\begin{twocolentry}{
    ...
    - Equipo con Ubuntu Server 24/7 que aloja mis proyectos con Docker y Docker Compose, administrando imágenes, volúmenes y redes de contenedores.\\
    - Publicación mediante Cloudflare Tunnel (HTTPS en subdominios propios), acceso remoto seguro mediante SSH y Tailscale sin exponer puertos.
\end{twocolentry}
...
\begin{twocolentry}{
    ...
    - Modelado relacional desde cero, con 34 tablas y 45 llaves foráneas, con disparadores y procedimientos almacenados en PL/pgSQL.\\
    - API REST en Spring Boot con JDBC y panel web para el CRUD. Trabajo en equipo.
\end{twocolentry}
...
\begin{twocolentry}{
    ...
    - App Django de reservaciones multisede con mapa interactivo (Leaflet/OpenStreetMap), reglas de negocio de temporada y roles de Visitante, Cliente y Administrador.\\
    - Desarrollo en equipo, con arquitectura basada en los patrones Facade, Template, \mbox{Observer} y Adapter, autenticación con Google y despliegue contenerizado en \mbox{\href{https://lumina-fest.jromerog.dev/}{lumina-fest.jromerog.dev}}.
\end{twocolentry}
...
\begin{onecolentry}
    \textbf{Lenguajes:} Java (Intermedio), Python (Intermedio), SQL\\
    \textbf{Backend:} Spring Boot (Intermedio; JPA/Hibernate, Spring Web, Swagger/OpenAPI), Django (Básico)\\
    \textbf{Bases de Datos:} PostgreSQL (Intermedio; modelado relacional, consultas avanzadas, PL/pgSQL), SQLite (Básico)\\
